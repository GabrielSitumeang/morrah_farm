        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('produk.tambah-gambar', $produk->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div>
                            <img src="chose.png" id="imgchose" height="200px" alt="">
                        </div>
                        <div class="form-group">
                            <label for="gambar">Gambar</label>
                            <input type="file" name="gambar_produk_detail" id="input" class="form-control" required>
                        </div>
